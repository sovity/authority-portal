...
class ClientIdUtilsTest {
    ...
    fun testGenerateClientId() {
        ...
        // act
        val result = clientIdUtils.generateFromCertificate(certString)
    ...
    private fun setupDb() {
        dsl.insertInto(Tables.CONNECTOR)
            ...
            .set(Tables.CONNECTOR.CREATED_BY, "00000000-0000-0000-0000-000000000001")
            .set(Tables.CONNECTOR.NAME, "connectorName")
            .set(Tables.CONNECTOR.FRONTEND_URL, "https://connectorUrl")
            .set(Tables.CONNECTOR.ENDPOINT_URL, "https://connectorUrl/api/dsp")
            .set(Tables.CONNECTOR.MANAGEMENT_URL, "https://connectorUrl/api/management")
        ...
        dsl.insertInto(Tables.COMPONENT)
            ...
            .set(Tables.COMPONENT.CREATED_BY, "00000000-0000-0000-0000-000000000001")
