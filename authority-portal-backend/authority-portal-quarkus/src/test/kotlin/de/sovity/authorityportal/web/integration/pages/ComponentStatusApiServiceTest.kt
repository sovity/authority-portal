...
class ComponentStatusApiServiceTest {
    ...
    fun getComponentStatusTest() {
        ...
        assertThat(resultEnv1.brokerStatus.timeSpanSeconds).isEqualTo(Duration.ofDays(30).toSeconds())
        assertThat(resultEnv1.brokerStatus.upSinceSeconds).isCloseTo(Duration.ofDays(5).toSeconds(), Offset.offset(5))
        ...
        assertThat(resultEnv2.brokerStatus.timeSpanSeconds).isEqualTo(Duration.ofDays(30).toSeconds())
        assertThat(resultEnv2.brokerStatus.upSinceSeconds).isCloseTo(Duration.ofDays(31).toSeconds(), Offset.offset(5))
