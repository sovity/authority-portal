...
class ComponentStatusApiServiceTest {
    ...
    private fun setupStatusHistory(now: OffsetDateTime, environment1: String, environment2: String) {
        ...
        dsl.insertInto(c)
            ...
            .values(ComponentType.CATALOG_CRAWLER, ComponentOnlineStatus.UP, environment1, now.minus(Duration.ofDays(50)))
            .values(ComponentType.CATALOG_CRAWLER, ComponentOnlineStatus.MAINTENANCE, environment1, now.minus(Duration.ofDays(20)))
            .values(ComponentType.CATALOG_CRAWLER, ComponentOnlineStatus.UP, environment1, now.minus(Duration.ofDays(15)))
            .values(ComponentType.CATALOG_CRAWLER, ComponentOnlineStatus.DOWN, environment1, now.minus(Duration.ofDays(10)))
            .values(ComponentType.CATALOG_CRAWLER, ComponentOnlineStatus.UP, environment1, now.minus(Duration.ofDays(5)))
